...
public class Cliente  implements Serializable{
	...
	//Usar uma coleção ao inves de criar uma classe Telefone / Conjunto de Strings
	@ElementCollection
	@CollectionTable(name = "TELEFONE")
	private Set<String> telefones = new HashSet<>();
	
	//Traz os perfis dos usuarios
	...
	public Cliente(Long id, String nome, String email, String cpfOuCpnj, TipoCliente tipo, String senha) {
		super();
		this.id = id;
		this.nome = nome;
		this.email = email;
